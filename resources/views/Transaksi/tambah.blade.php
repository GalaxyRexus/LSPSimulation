...
<main class="main users chart-page" id="skip-target">
    <div class="container">
<h2 class="main-title">Tambah Transaksi</h2>
<article class="sign-up">
    <form class="sign-up-form form" action="{{ route('transaksi.store') }}" method="POST">
        @csrf
      <label class="form-label-wrapper">
        <p class="form-label">Waktu Layanan</p>
        <input class="form-input" name="waktu_transaksi" type="date" placeholder="Tanggal"  required>
      </label>
      <div class="input-group mb-3">
      <label class="form-label-wrapper">
        <p class="form-label">Nama Pelanggan</p>
        <input class="form-input" name="nama_pelanggan" type="text" placeholder="Masukkan Nama Pelanggan" required>
      </label>
      ...
      <label class="mb-3 form-label-wrapper">
        ...
        <input class="form-input" name="berat" type="number" placeholder="Masukkan Berat" required>
      </label>
      <label class="mb-3 form-label-wrapper">
